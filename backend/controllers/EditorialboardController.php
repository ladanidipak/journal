...
class EditorialboardController extends BaseController
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $uploadedFile_editor_consent_form = \yii\web\UploadedFile::getInstance($model, 'editor_consent_form');
            if ($uploadedFile_editor_consent_form) {
                $model->editor_consent_form = $uploadedFile_editor_consent_form;
                $model->editor_consent_form->name = time() . "_" . Common::clean($model->editor_consent_form->name);
            } else {
                unset($model->editor_consent_form);
            }
