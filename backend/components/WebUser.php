...
class WebUser extends CoreUser {
    ...
    public function loadPermissions($user_group) {
        ...
        if($this->_model->type == Users::CONFERENCE_USER){
            $permissionArr = ['159'=>'article/conference', '101'=>'article/view', '167'=>'article/checkcertificate', '168'=>'article/submit' ,
                '169'=>'article/updateproceeding', '93'=>'dashboard/index', '153'=>'conference/conference', '160'=>'article/createproceeding',
                '174' => 'article/uploadcopyright', '181' => 'article/sendcertificate'
            ];
        }
        //ob_clean();echo "<pre>".print_r($permissionArr,true);exit;
