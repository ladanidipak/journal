...
namespace app\templates\inspinia\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function generateRules($table)
    {
        ...
        foreach ($table->columns as $column) {
            ...
            if (!$column->allowNull && $column->defaultValue === null && !in_array($column->name, array('is_deleted', 'status','updated_by','updated_date','updated_dt','created_by','created_date','created_dt'))) {
