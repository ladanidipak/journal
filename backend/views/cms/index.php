            ...
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    ...
                    if (common::checkActionAccess("{$this->context->id}/create")) {
                        echo Html::a('<i class="fa fa-plus"></i> Create Page', ['create'], ['class' => 'btn btn-primary btn-xs']);
                    }
                    ?>
                </div>
            </div>
                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'header' => 'Action',
                                'template' => Common::gridViewButton($this->context->id) . ' ' . Common::gridUpdateButton($this->context->id),
                            ],
                        ],
                    ]);
                    ?>
