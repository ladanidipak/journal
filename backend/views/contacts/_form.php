...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content contact-form" style="display: block;">
                ...
                <div class="row">
                    ...
                    <?= $form->field($model, 'list_id')->dropDownList(\backend\models\ContactList::getList(),Common::getDropDownOptions($model,'list_id')) ?>
