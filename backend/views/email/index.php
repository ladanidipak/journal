                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'header' => 'Action',
                                'template' => "{send}" . Common::gridViewButton($this->context->id) . ' ' . Common::gridUpdateButton($this->context->id) . ' ' . Common::gridDeleteButton($this->context->id),
                                'buttons' => [
                                    'send' => function($url,$model){
                                        return (common::checkActionAccess("email/send")) ? Html::a(' <span class="fa fa-send"></span>', $url,['class'=>'text-success','title'=>'Send Email']) : "";
                                    }
                                ]
                            ],
                        ],
