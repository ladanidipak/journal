...
/* @var $searchModel backend\models\search\BoardCertificatesLogs */
...
<div class="row board-certificates-logs-index">
    <div class="col-lg-12">
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'header' => 'Action',
                                'template' => Common::gridDeleteButton($this->context->id),
                            ],
                        ],
                    ]); ?>
                    <?php Pjax::end(); ?>
