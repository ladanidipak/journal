                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                                                                    ...
                                                                    <tr>
                                                                        <td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#222;font-family:"Helvetica Neue", Arial;font-size:14px;line-height:130%;text-align:left;padding-top:18px;padding-bottom:0px;padding-left:15px;padding-right:15px;'>
                                                                            <p style="margin:0;padding-bottom:0"><b>Rejection of Manuscript - <?= date('d/m/Y')?></b></p>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                                                                    ...
                                                                    <tr>
                                                                        <td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#222;font-family:"Helvetica Neue", Arial;font-size:14px;line-height:130%;text-align:left;padding-top:18px;padding-bottom:18px;padding-left:15px;padding-right:15px;'>
                                                                            <p style="margin:0;padding-bottom:1em">Dear Author,<br />
                                                                                <br />
                                                                                Thanks for submitting your paper entitled <strong><?= $model->article_title?></strong> with ID <strong><?= $model->paper_id?></strong> in GRDJE.</p>
                                                                            <p style="margin:0;padding-bottom:1em">GRDJE is purely bound to quality of research work to recognize creative, research work to the world. We are sorry to let you know that <strong>your paper is rejected in current issue of publication.</strong></p>
                                                                            <p style="margin:0;padding-bottom:1em">GRD Journal sends your research articles to reviewers of the areas related to paper. Unfortunately, based on the reviewer’s recommendations, we can’t select your paper<strong>.</strong> </p>
                                                                            <p style="margin:0;padding-bottom:1em">Please find the attached review report which might help you to find and correct the flaws in your work and can help you to improve your article.</p>
                                                                            <p style="margin:0;padding-bottom:1em">If you find your article convincible after changing it, you can submit it again as you did before.<br />
                                                                                <br />
                                                                                Again, thank you for giving us the opportunity to consider your paper for GRD Journals.</p>
                                                                            <p style="margin:0;padding-bottom:1em">Please feel free to discuss with us.</p>
                                                                            ...
                                                                            <p style="margin:0;padding-bottom:1em"><span style="line-height: 1.6em;">We would be happy to help you.</span></p>
                                                                            <p style="margin:0;padding-bottom:1em"><br />
                                                                                Thanks &amp; Regards,<br />
                                                                                <strong>Editor in Chief<br />
                                                                                    Global Research and Development Journals (GRD Journals) </strong>(<a href="http://www.grdjournals.com/" style="word-wrap:break-word;color:#15C;font-weight:normal;text-decoration:underline">www.grdjournals.com</a>)</p>
