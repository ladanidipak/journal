                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                                                                    ...
                                                                    <tr>
                                                                        <td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#222;font-family:"Helvetica Neue", Arial;font-size:14px;line-height:130%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;'>
                                                                            <p style="margin:0;padding-bottom:1em;text-align: center;"><span style="font-size:20px;"><strong><span style="color:#A9A9A9;">Global Research and Development Journal for Engineering (GRDJE)</span></strong></span></p>
                                                                ...
                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                                                                    ...
                                                                    <tr>
                                                                        <td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#222;font-family:"Helvetica Neue", Arial;font-size:14px;line-height:130%;text-align:left;padding-top:18px;padding-bottom:0px;padding-left:15px;padding-right:15px;'>
                                                                            <p style="margin:0;padding-bottom:0"><b>Your manuscript has been submitted successfully !!! - <?= date('d/m/Y')?></b></p>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                    ...
                                                                    <tr>
                                                                        <td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#222;font-family:"Helvetica Neue", Arial;font-size:14px;line-height:130%;text-align:left;padding-top:18px;padding-bottom:18px;padding-left:15px;padding-right:15px;'>
                                                                            <p style="margin:0;padding-bottom:1em">Dear Author,<br />
                                                                                <br />
                                                                                Thank you for submitting your Article entitled with <strong>"<?= $model->article_title?>"</strong> in Global Research &amp; Development Journal for Engineering (GRDJE). </p>
                                                                            <p style="margin:0;padding-bottom:1em">For the future interaction your article id is <strong><?= $model->paper_id?></strong>.<br />
                                                                                Your article will be sent to relevant reviewer soon. You will get the response regarding Approval or Rejection as soon as it gets reviewed.</p>
                                                                            <p style="margin:0;padding-bottom:1em">To check your paper status, please <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['page/paperstatus']) ?>" style="word-wrap:break-word;color:#15C;font-weight:normal;text-decoration:underline">CLICK HERE</a></p>
                                                                            <p style="margin:0;padding-bottom:1em">Please keep the Article ID with you for all future communications.</p>
                                                                            <p style="margin:0;padding-bottom:1em">For any queries or assistance please contact us at: <br />
                                                                                Email: <a href="file:///C:/Users/Divyang%20Shah/AppData/Local/Temp/Rar%24DIa0.319/info@grdjournals.com" style="word-wrap:break-word;color:#15C;font-weight:normal;text-decoration:underline">info@grdjournals.com</a><br />
                                                                                Phone: <a href="tel:+917405407107" style="word-wrap:break-word;color:#15C;font-weight:normal;text-decoration:underline">+91 740 540 7107</a></p>
                                                                            <p style="margin:0;padding-bottom:1em"><strong>Regards,<br />
                                                                                    GRD Journals Team</strong></p>
                                                                            <p style="margin:0;padding-bottom:0;text-align: center;"><span style="color:#A9A9A9;">GRD Journals - Redefining Research </span></p>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
