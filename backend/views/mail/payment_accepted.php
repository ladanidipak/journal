                                                                    ...
                                                                    <tr>
                                                                        <td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#222;font-family:"Helvetica Neue", Arial;font-size:14px;line-height:130%;text-align:left;padding-top:18px;padding-bottom:18px;padding-left:15px;padding-right:15px;'>
                                                                            <p style="margin:0;padding-bottom:1em">Dear Author(s),<br />
                                                                                <br />
                                                                                Your paper entitled <strong><?= $model->article_title ?></strong>  with ID <strong><?= $model->paper_id ?></strong> is yet to be published in our journal GRD Journal for Engineering(GRDJE).<br />
                                                                                <br />
                                                                                You can find your certificates at the attachment. For any queries please contact us at: </p>
                                                                            ...
                                                                            <p style="margin:0;padding-bottom:1em">Looking forward for good co-operation.<br />
                                                                                Please feel free to discuss with us. We would be happy to help you.<br />
                                                                                <br />
