...
<div class="modal-body">
    <div class="row review-popup">
        ...
        <table class='table-responsive table-bordered col-sm-12'>
            ...
            <?php if($reviews && isset($reviewArray['que_2'])):
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-danger btn-sm edit-review" href="<?= Url::to(['editreview', 'id' => $article->id])?>" data-id="<?= $article->id?>" data-pjax="0" ><i class="fa fa-ticket"></i> Edit Review </a>
            <a class="btn btn-danger btn-sm" href="<?= Url::to(['downloadreport', 'id' => $article->id])?>" data-id="<?= $article->id?>" data-pjax="0" ><i class="fa fa-file"></i> Download</a>
        </div>
    </div>
