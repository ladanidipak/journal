...
/**
 * ConfProSearch represents the model behind the search form about `backend\models\ConfPro`.
 */
class ConfProSearch extends ConfPro
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'conf_type', 'is_deleted', 'created_dt', 'updated_dt', 'updated_by'], 'integer'],
            [['conf_cor_name', 'email', 'org_name', 'phone', 'org_website', 'dept_name', 'aff_by', 'title', 'description', 'short_name', 'conf_date', 'specialization', 'venue', 'conf_website', 'brochure', 'search'], 'safe'],
        ];
    }
