 ...
 */
class ConfPro extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['conf_cor_name', 'email', 'org_name', 'phone', 'org_website', 'dept_name', 'aff_by', 'title', 'description', 'short_name', 'conf_date', 'specialization', 'venue', 'conf_website','conf_type'], 'required'],
